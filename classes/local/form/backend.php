...
class backend extends \core\form\persistent {
    ...
    protected function definition() {
        ...
        $mform->addElement('text', 'url', get_string('url', 'report_datawarehouse'));
        $mform->addRule('url', get_string('required'), 'required', null, 'client');
        $mform->setType('url', PARAM_TEXT);

        $mform->addElement('text', 'username', get_string('username', 'report_datawarehouse'));
        $mform->setType('username', PARAM_TEXT);

        $mform->addElement('text', 'password', get_string('password', 'report_datawarehouse'));
        $mform->setType('password', PARAM_TEXT);

        $mform->addElement('selectyesno', 'enabled', get_string('enabled', 'report_datawarehouse'));
        $mform->setType('enabled', PARAM_INT);

        $mform->addElement('text', 'alloweduser', get_string('alloweduser', 'report_datawarehouse'));
