...
/**
 * Event for when a run is created.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class run_created extends base {
    ...
    public static function get_name() {
        return get_string('event:runcreated', 'report_datawarehouse');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created a run with id '$this->objectid'.";
    }
