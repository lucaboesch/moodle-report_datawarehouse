...
class query_updated extends base {
     ...
     *
     * @param \report_datawarehouse\query $query Report data warehouse query.
    ...
    public static function get_name() {
        return get_string('event:queryupdated', 'report_datawarehouse');
    }
