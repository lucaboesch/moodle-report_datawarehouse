...
/**
 * Event for when a run is disabled.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class run_disabled extends base {
    ...
    public static function get_name() {
        return get_string('event:rundisabled', 'report_datawarehouse');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has disabled a run with id '$this->objectid'.";
    }
