...
namespace report_datawarehouse\task;
...
class run_reports extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('crontask', 'report_datawarehouse');
    }
    ...
    public function execute() {
        ...
        foreach ($reportstorun as $report) {
            mtrace("... Running report " . report_datawarehouse_plain_text_report_name($report));
            try {
                report_datawarehouse_generate_csv($report, $timenow);
            } catch (\Exception $e) {
